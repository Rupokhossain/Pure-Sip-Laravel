    ...
    <section className="relative z-20 py-14 px-4 sm:px-8 lg:px-12 w-full bg-gradient-to-b from-[#f4faf4] via-[#eaf4ec] to-[#f4faf4] selection:bg-[#183928] selection:text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-16 lg:space-y-20">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#183928] text-emerald-300 text-xs sm:text-xs font-black tracking-widest uppercase px-5 py-2 rounded-full shadow-lg border border-emerald-700/50">
            <span>THE PURITY STANDARD</span>
            <span className="text-sm">🌿</span>
          </div>

          <h2 className="text-3xl lg:text-5xl font-black text-[#112318] tracking-tight leading-[1.12]">
            Crafted Botanicals. <br className="hidden sm:inline" />
            <span className="text-[#183928]">Zero Artificial Compromise.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#112318] tracking-tight">
              Real Botanical Roots for Natural Well-Being
            </h3>

            <p className="text-gray-700 text-sm sm:text-base leading-relaxed font-normal">
              At Pure Sip Beverage, we believe true refreshment comes directly from the earth. 
              Our small-batch cold blends extract the purest essence of traditional herbs, raw fruits, 
              and authentic spices—bringing you a pure experience without a single drop of chemical additives.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-y border-emerald-900/10 py-5 max-w-lg">
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium mt-0.5">Real Botanical Brew</p>
              </div>
              <div>
                <h4 className="text-2xl sm:text-3xl font-black text-[#183928]">0g</h4>
                <p className="text-xs text-gray-500 font-medium mt-0.5">Harmful Preservatives</p>
              </div>
              <div>
                <h4 className="text-2xl sm:text-3xl font-black text-[#183928]">4.9★</h4>
                <p className="text-xs text-gray-500 font-medium mt-0.5">Over 15,000 Sips</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            <div className="relative w-full max-w-[480px] aspect-[4/4.5] rounded-3xl overflow-hidden shadow-2xl border-white bg-white group">
              <img
                ...
                alt="Pure Sip Botanicals and Ingredients"
